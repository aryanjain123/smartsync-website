    ...
    <header className={`navbar ${scrolled ? 'scrolled' : ''}`}>
      <div className="nav-container">
        ...
        <nav className="desktop-nav">
          ...
          <a href="https://missionsmile.smartsyncservices.com/learn" className="nav-link" target="_blank" rel="noopener noreferrer">MissioN S.M.I.L.E</a>
        ...
        {mobileMenuOpen && (
          ...
          >
            <div className="mobile-nav-content">
              ...
              <a href="https://missionsmile.smartsyncservices.com/learn" className="mobile-nav-link" onClick={() => setMobileMenuOpen(false)} target="_blank" rel="noopener noreferrer">MissioN S.M.I.L.E</a>
